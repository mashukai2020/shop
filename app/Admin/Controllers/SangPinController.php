...
class SangPinController extends AdminController
{
    /**
    ...
    protected function grid()
    {
        ...
        $grid->column('add_time', __('Add time'))->display(function($time){return date('Y-m-d H:i:s');});
    ...
    {
        $show = new Show(SangPin::findOrFail($id));
